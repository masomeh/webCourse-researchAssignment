...
در جداسازی کدهایمان از سرور بهتر است بدانیم که صرف استفاده از معماری MVC یا همان model، view و controller به معنای این جداسازی نمی باشد، چرا که باز هم باید برای تغییر، ذخیره و رندر کردن محتوا به سرور دسترسی داشته باشیم. بلکه باید کل معماری MVC را در سمت کلاینت پیاده سازی کنیم.
<br>
